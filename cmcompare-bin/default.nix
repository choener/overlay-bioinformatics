...
stdenv.mkDerivation rec {
  version = "0.0.1";
  name = "cmcompare-bin-${version}";

  src = fetchurl {
    url = "https://www.tbi.univie.ac.at/software/cmcompare/src/hsCMCompare-archlinux-x64.gz";
    sha256 = "1qhajv3zyciqm47jblrf06h7c01f4pi50dksf3w6zgmgwjxkvfmk";
  };
